...
do
  ...
  if [ -f "vcf_baseq_20/${rt}_annotated.txt" ]; then
    ...
    ./mutserve/mutserve call bam/${rt}_sorted.bam --threads 8 --baseQ 20 --mapQ 18 --level 0.001 --reference mutserve/rCRS.fasta --output vcf_baseq_20/${rt}.vcf ;
